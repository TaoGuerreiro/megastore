...
class OrderPresenter < BasePresenter
  ...
  STATUS_COLORS = {
    ...
    confirmed: { bg: "bg-yellow-500", text: "text-contrast", raw: "-yellow-500", exa: "#EAB308",
                 colored_text: "text-yellow-500" },
    refunded: { bg: "bg-indigo-800", text: "text-contrast", raw: "-indigo-800", exa: "#3730A3",
                colored_text: "text-indigo-800" },
    paid: { bg: "bg-green-500", text: "text-contrast", raw: "-green-500", exa: "#22C55E",
            colored_text: "text-green-500" },
    sent: { bg: "bg-green-500", text: "text-contrast", raw: "-green-500", exa: "#22C55E",
            colored_text: "text-green-500" },
